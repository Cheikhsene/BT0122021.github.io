...
<html lang="en">
    <head>
        ...
        <title>Page d'inscription | BMO</title>
...
return true;
    ...
    <body  style="background: url(&quot;assets1/img/709832.jpg&quot;) center / cover, rgba(5,30,30,0);opacity: 50;filter: blur(0px);">
...
<hr />
                                        <h3 class="text-center font-weight-light my-4"></h3></div>
                                    <div class="card-body">
...
<input class="form-control" id="email" name="email" type="email" placeholder="email@blackman.online" required />
...
<label for="inputcontact">Téléphone</label>
</div>
...
<div class="d-grid"><button type="submit" class="btn btn-primary btn-block" name="submit">S'inscrire</button></div>
 ...
 <div class="small"><a href="login.php">Déjà inscrit ? Connexion</a></div>
  <div class="small"><a href="index.php">Page d'acceuil</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
